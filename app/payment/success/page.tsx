...
function PaymentSuccessContent() {
	...
	const [showSussessModal, setShowSussessModal] = useState(false)
	...
	return (
		<div className="min-h-screen flex items-center justify-center  p-4">
			...
			>
				...
				{/* Подзаголовок */}
				<p className="text-gray-subtext text-center mb-6">Пожалуйста, введите свой ник в игре, чтобы мы могли зачислить вам голду</p>
				{/* Инпут */}
				<input
					type="text"
					value={nickname}
			...
			{showSussessModal && (
				<div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-xs">
					...
					>
						...
						{/* Заголовок */}
						<h2 className="text-win-title mb-2 text-center">Отлично</h2>
						{/* Подзаголовок */}
						<p className="text-gray-subtext text-center mb-6">Пожалуйста, ожидайте, идет обработка вашего платежа.</p>
